...
![sizzle](/images/hackthebox-writeups/sizzle/htb.png)
...
![smbenumeration](/images/hackthebox-writeups/sizzle/smbenum.png)
...
![certlm](/images/hackthebox-writeups/sizzle/certsrv-login.png)
...
![hash](/images/hackthebox-writeups/sizzle/amanda-hash.png)
...
![certsrv](/images/hackthebox-writeups/sizzle/certsrv.png)
![request-cert](/images/hackthebox-writeups/sizzle/certgen.png)
![downlaod](/images/hackthebox-writeups/sizzle/download-cert.png)
...
_Evil-WinRM_ PS C:\Users\amanda\Documents> whoami
htb\amanda
{% endhighlight %}

## Covenant C2 Framework

To get a better overview of the AD Environment we will use [Covenant](https://github.com/cobbr/Covenant), you can install it following the guide [here](https://github.com/cobbr/Covenant/wiki/Installation-And-Startup)
...
![applocker-bypass](/images/hackthebox-writeups/sizzle/grunt.png)

### Domain enumeration with Covenant

![c2](/images/hackthebox-writeups/sizzle/grunt-1.png)

![c2](/images/hackthebox-writeups/sizzle/shell-spn.png)

![c2](/images/hackthebox-writeups/sizzle/spn.png)
...
![grunt-2](/images/hackthebox-writeups/sizzle/grunt-2.png)

### PowerView Enumeration

Firstly, we will load up PowerView and find all principals with `Replication Rights`

![pwdl](/images/hackthebox-writeups/sizzle/powerview-dlwd.png)

![import](/images/hackthebox-writeups/sizzle/import.png)
...
![import](/images/hackthebox-writeups/sizzle/sid.png)

![import](/images/hackthebox-writeups/sizzle/sid-1.png)
...
![dcsync](/images/hackthebox-writeups/sizzle/dcsync.png)
...
![rooted](/images/hackthebox-writeups/sizzle/root.gif)
...
![system-grunt](/images/hackthebox-writeups/sizzle/grunt-3.png)

![system-grunt](/images/hackthebox-writeups/sizzle/grunt-4.png)
...
![flags](/images/hackthebox-writeups/sizzle/flags.gif)

## Pwned

![pwned](/images/hackthebox-writeups/sizzle/pwned.png)
